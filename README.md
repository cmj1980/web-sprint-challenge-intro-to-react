...
It is a JS Liabary created by FB. It allows us to create more managable componets of data to help with, maintenance, upgradation, and data flow.
1. Describe component state.
In shirt it is an object that holds some information that may change over time. It is an instance of ReactJS componets that controls the behaior of the componet. 
1. Describe props.
(props aka properties) is data passed from partent to child
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Anything that effects something out the scope of the function. We can sync it by using useEffect and setting state inside of useEffect.
